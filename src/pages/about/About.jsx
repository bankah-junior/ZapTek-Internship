    ...
    <div className='aboutPage__container overflow-hidden'>
      <section className="aboutPage__container-top_section w-full md:h-screen relative mt-24 md:mt-0">
        <div className='h-full flex flex-col justify-center py-4 px-12'>
          <h2 className="uppercase font-bold text-4xl md:text-5xl primary-color w-full text-center mb-6 md:mb-0">about us</h2>
          <h3 className="uppercase font-semibold text-2xl md:text-3xl text-white">Get your fitness <br /> brand to the digital <br /> world.</h3> <br /><br />
          <h3 className="uppercase font-semibold text-2xl md:text-3xl text-white">Together we create, <br /> we design, we fit.</h3>
        </div>
      ...
      <section className="aboutPage__container-bottom_section w-full md:h-screen" style={{backgroundColor: "rgba(0,0,0,0.7)"}}>
        <h2 className="uppercase font-bold text-3xl md:text-4xl primary-color w-full mb-6 pt-6 text-center ml-6 md:mb-0">we are</h2>
        <div className="about__gallery flex flex-col md:flex-row justify-between p-8 md:mt-20">
          <div className="about__gallery-left relative flex justify-center items-center mb-24">
            <h3 className="uppercase text-xl font-semibold text-white absolute left-0 md:top-c5" style={{top: "-2rem", lineHeight: "21.09px"}}>
              Content creators and social <br /> media managers
            </h3>
            <img src={galleryImg1} alt="" />
            <h3 className="uppercase text-xl font-semibold text-white absolute right-0 md:bottom-c5" style={{bottom: "-2rem", lineHeight: "21.09px"}}>
          ...
          <div className="about__gallery-right flex flex-col">
            <div className="top relative flex flex-col justify-center items-center mb-8">
              ...
              <div className="relative flex justify-center items-center" style={{bottom: "2rem"}}>
                <span className="uppercase text-right text-xl font-semibold text-white">
